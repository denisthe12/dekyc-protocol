...
exports.deriveFieldsFromIin = deriveFieldsFromIin;
function deriveFieldsFromIin(iin) {
    if (!iin) {
        return {
            birthDate: null,
            gender: null,
...
function resolveCenturyAndGender(digit) {
    switch (digit) {
        case '1':
...
//# sourceMappingURL=iin-derived-fields.js.map