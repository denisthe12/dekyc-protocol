...
exports.SubjectsModule = SubjectsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [subject_id_service_1.SubjectIdService, subjects_service_1.SubjectsService],
        exports: [subject_id_service_1.SubjectIdService, subjects_service_1.SubjectsService],
    })
], SubjectsModule);
